...
```{r}
assay(sce,"logcounts") <- scater::normalizeCounts(assay(sce,"counts"),size_factors=librarySizeFactors(assay(sce,"counts")))
...
使用droplet-based数据集(来自scRNAseq包)展示一个快速处理SC数据的示例
